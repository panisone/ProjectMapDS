...
@interface FavoriteImageViewController ()
...
- (void)viewDidLoad
{
    ...
    self.pageViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"FavoritePageViewController"];
    self.pageViewController.dataSource = self;
    
    FavoriteContentViewController *startingViewController = [self viewControllerAtIndex:0];
...
- (FavoriteContentViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    FavoriteContentViewController *pageContentViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"FavoriteContentViewController"];
...
{
    NSUInteger index = ((FavoriteContentViewController *) viewController).pageIndex;
